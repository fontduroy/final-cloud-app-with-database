# Generated by Django 3.1.3 on 2023-04-07 14:42
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('text', models.CharField(default='<missing choice text>', max_length=1024)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('text', models.CharField(default='<missing question text>', max_length=1024)),
                ('grade_point', models.IntegerField(default=0)),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='onlinecourse.course')),
            ],
        ),
        migrations.CreateModel(
            name='Lesson',
